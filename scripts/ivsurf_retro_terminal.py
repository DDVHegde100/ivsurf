...
class RetroTerminal:
    ...
    def __init__(self):
        ...
        self.swing_engine = SwingSignalEngine()
    ...
    def fetch_ticker_data(self, ticker):
        ...
        return engine_fetch_ticker_data(ticker, self.swing_engine)
    ...
    def calculate_tomorrow_gain_prediction(self, hist, current_price, volatility, rsi, macd, bb_position,
        ...
        """Delegate to engine swing signal scorer."""
        return self.swing_engine.calculate_tomorrow_gain_prediction(
    ...
    def calculate_tomorrow_gain_potential(self, hist, current_price, volatility, gain_prediction_score):
        """Delegate to engine gain potential estimator."""
        return self.swing_engine.calculate_tomorrow_gain_potential(
